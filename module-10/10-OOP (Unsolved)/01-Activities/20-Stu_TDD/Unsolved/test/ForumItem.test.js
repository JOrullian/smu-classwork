...
describe('ForumItem', () => {
  ...
  // Checks that forumitem is a new instance of ForumItem class
  ...
  // Add a comment describing this test.
  // Checks that authorName is correctly added to forumitem
  ...
  // Add a comment describing this test.
  // Checks that comment is correctly added to forumitem
  ...
  // Add a comment describing this test.
  // Checks that printMetaData() correctly prints inputs of forumitem
