...
app.post('/api/reviews', (req, res) => {
  ...
  // Desctructuring req.body into product, review and username
  ...
  // Checking to make sure product, review and username parameters all exist
  if (product && review && username) {
    ...
    // sends back a status 201 along with the response as json
    res.status(201).json(response);
  } else {
    // TODO: Add a comment describing the purpose of the else statement in this POST request.
    // sends back a status 500 error response
