...
// primeArray is being filtered into only prime numbers based on the isPrime function (output = 3, 2, 5)
const primeArray = originalArray.filter(isPrime);
console.log(primeArray);


// TODO: Describe how filter is working in this example. What will the value of moreThan5Array be?
//  primeArray is being filtered into only numbers greater than 5 (output = 10)
